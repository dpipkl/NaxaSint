...
def banner():
            animation (f"""
    {BLUE}𝚗𝚊𝚡𝚊 𝚍𝚘𝚡𝚒𝚗𝚐 𝚝𝚘𝚘𝚕𝚜        
            Version 10 - 2025 coded by Narendra
...
####################
          ...
          instagram()
                                     ...
                                     sleep(1)
                                     print(f"""{NORMAL}
The Naxa tool is a tool for searching phone number information 
...
{GREEN}Narendra {NORMAL}to help you get phone number information. If you want 
To recode this tool don't forget to include the developer's name to
Credit the coder.

// {WHITE}TRANSLATE TO INDONESIAN{NORMAL}

Alat Naxa adalah alat untuk mencari informasi nomor telepon 
...
Oleh {GREEN}Narendra {NORMAL}untuk membantu Anda mendapatkan informasi nomor 
